...
function run($ig) {
    try {
        ...
        $license_key = ("be401d794e2ca130ef5cbb5c6c5cdf52");

        if (empty($license_key)) {
            do { 
                $license_key = getVarFromUser("be401d794e2ca130ef5cbb5c6c5cdf52");
...
function define_targets($ig) {
    ...
    do {
        ...
        $targets_input = ("najwashihab, awreceh.id, kegoblogan.unfaedah, dramaojol.id, radenrauf, info_kejadian_makassar, makassar_iinfo, anakunhas, hasanuddin_univ, info.bulukumba, tumming_abu, psm_makassar, mahasiswa.mks, raditya_dika, iqbaal.e, aliandooo, duniamanji, tirtoid, ariefmuhammad, indovidgram, viavallen, brianimanuel, bastiansteel, hanan_attaki, bassitoayya, nurdin.abdullah, fiersabesari, jefrinichol, jeromepolin, susipudjiastuti115, mamakbeti, alghazali7, sorayarasyid12, igineyz, dagelan, explorebandung,explorebali, exploresemarang, explorelombok, explorejakarta,explorejogya, explorepekanbaru, exploresurabaya, exploregresik, exploretasikmalaya, exploresumedang, exploretangerang, explorekediri, explorekudus, exploreserang, explorebangka, explorepekalongan, explorepurwakarta, exploreriau, explorebima, explorepontianak, explorepalembang, exploretegal, indonesia6am, pendaki.cantik, gunungindonesia, pendakicantikindonesia, instapendaki, pendakiindonesia, vaneshaass, ashanty_ash, yang.terdalam, prabowo, jokowi, tiktokfunny, princessyahrini, ayutingting92, raffinagita1717, raisa6690, isyanasarasvati, chelseaoliviaa, lunamaya, agnezmo, afgansyah.reza, hajarans, pusakata
susipudjiastuti115, kevinjulio1993, rapyourbae, _irishbella_, giorgino_abraham, tatjanasaphira, bclsinclair, ashrafsinclair,audimarissa, gisel_la, yukikt, ichasoebandono, dude2harlino, glennalinskie, inijedar, sarwendah29, natashawilona12, aurakasih, alghazali7, ussypratama, gadiiing, sandradewi88, agnezmo, jscmila, aurakasih, bclsinclair, aurelie.hermansyah, claurakiehl, jevinjulian, rinni_w, putrimarino, chicco.jerikho,ramadhaniabakrie, raditya_dika, bramastavrl, amandamanopo, putrimarino, rizkyalatas, adzanabs, alisyakieb, citraciki, nikitawillyofficial94, marshanda99, atiqahhasiholan, riodewanto, ririnekawati, cacatengker, frandaaa87, fahrihamzah, raditya_dika, ariefmuhammad, netflixid, vincentraditya, iqbaal.e, jefrinichol, brandonsalim, andovidalopez, vidialdiano, julianjacs, sibisma, okintph, aldymldni, gadiiing, aliandooo, joe_taslim, jonatanchristieofficial, attahalilintar, ariirham, memecomic.id, kegoblokan.anfaedah, cnnindonesia, netmediatama, beautifuldestinations , lorealmakeup , makeup_clips, bioaquamask.official, naturerepublic.id, wardahbeuty, jokowi, infojepara_id, jeparaid, jeparakekinian, explorejepara, jeparahariini, persijapjepara,wisatasemarang,infokejadiansemarang, aslisemarang, semarang, eventsemarang, seputarsemarang, exploresemarang , semarangkalem, dramatwitteran, twittereceh, dramatwitter.id, recehintwitter, kata.nyesek, tumblr.indo, pejuang.harapan, sindirankeren.id, drama.sosialmedia, pekadoi, yang.terdalam, zonabaper.id, pejuang.kampus, sekedar.rahasia, zonanyaman.idn, remajabaperan.id, tweetreceh, dramatwiter.id, twitter.update, fokusquotes, twider.id, jendelatwitter, kata2cewek, twitt, rei, nagita_raffi1717  ");
